...
def cols_for_rec_and_person(rec, person)
  date_format = "%D"
...
person_includes = [:card_accounts, :card_recommendations, :readiness_status, :spending_info, :eligibility]
...
path = Rails.root.join("tmp", "account-dump-#{rand(10000)}.csv")
