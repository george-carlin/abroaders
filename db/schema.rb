...
ActiveRecord::Schema.define(version: 20170807223833) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["fb_token"], name: "index_users_on_fb_token", using: :btree
    t.index ["onboarding_state"], name: "index_users_on_onboarding_state", using: :btree
    t.index ["phone_number_normalized"], name: "index_users_on_phone_number_normalized", using: :btree
