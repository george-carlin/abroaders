...
module AdminArea
  class CardRecommendationFiltersOnPage < ObjectOnPage
    ...
    check_box :all_independent_currencies, "card_currency_filter_all_independent"
    check_box :all_one_world_currencies, Proc.new { "card_currency_alliance_filter_all_for_#{Alliance.find_by_name("OneWorld").id}" }
    check_box :all_sky_team_currencies, Proc.new { "card_currency_alliance_filter_all_for_#{Alliance.find_by_name("SkyTeam").id}" }
