...
describe Account do
  ...
  describe "#onboarded?" do
    ...
    context "when the account has not onboarded home airports" do
      it { is_expected.to be false }
    end

    context "when the account has onboarded home airports" do
      before { account.onboarded_home_airports = true }
