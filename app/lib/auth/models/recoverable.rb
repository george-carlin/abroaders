  ...
  module Models
    ...
    module Recoverable
      ...
      def set_reset_password_token
        raw, enc = Auth.token_generator.generate(self.class, :reset_password_token)
      ...
      module ClassMethods
        ...
        def with_reset_password_token(token)
          reset_password_token = Auth.token_generator.digest(self, :reset_password_token, token)
        ...
        def reset_password_by_token(attributes = {})
          ...
          reset_password_token = Auth.token_generator.digest(self, :reset_password_token, original_token)
